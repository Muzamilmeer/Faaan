...
<body>
  ...
  <section id="form" style="display: flex; justify-content: center; align-items: flex-start; flex-wrap: wrap; gap: 30px; padding: 40px 20px;">
    <div class="dealer-card" style="text-align: center; padding: 15px; border-radius: 15px; background: #fff; max-width: 180px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
      <img src="https://res.cloudinary.com/dxjkbpmgm/image/upload/v1751171172/IMG_20250629_095415_i8gy5w.png" alt="Saleem" style="border-radius: 15px; max-width: 150px; height: 200px; object-fit: cover;" />
      <h4>Saleem</h4>
      <p style="font-size: 0.9em;">Young entrepreneur passionate about high-quality trout distribution and fish farm development in Bandipora.</p>
      <a href="https://wa.me/919682361172" target="_blank">
    ...
    <div>
      ...
      <form onsubmit="sendWhatsApp(event)">
        ...
        <textarea id="message" placeholder="Any message..." required></textarea>
        <button class="button" type="submit">Send Inquiry</button>
      </form>
    </div>

    <div class="dealer-card" style="text-align: center; padding: 15px; border-radius: 15px; background: #fff; max-width: 180px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
      <img src="https://res.cloudinary.com/dxjkbpmgm/image/upload/v1751171170/IMG_20250629_095142_puzohw.png" alt="Waseem" style="border-radius: 15px; max-width: 150px; height: 200px; object-fit: cover;" />
      <h4>Waseem</h4>
      <p style="font-size: 0.9em;">10+ years of experience in trout farming. Trusted by local and commercial clients across Kashmir.</p>
      <a href="https://wa.me/919149915607" target="_blank">
        <img src="https://img.icons8.com/color/48/000000/whatsapp--v1.png" alt="WhatsApp" width="40" height="40">
      </a>
    </div>
  </section>
  ...
  <section id="contact">
    ...
    <p>
      📞 9149915607<br>
      📞 9682361172<br>
      📧 saleemmir1855@gmail.com<br>
      📧 meerwaseem698@gmail.com<br>
      📍 Bandipora, Kashmir
    </p>
